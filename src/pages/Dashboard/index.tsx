...
const Dashboard: React.FC = () => {
  ...
  function makeOutcomeText(value: number): string {
    const outcomeValueFormated = formatValue(Number(value));
    const outcomeText = `- ${outcomeValueFormated}`;
    return outcomeText;
  }
                ...
                <tr key={transaction.id}>
                  ...
                  >
                    {transaction.type === 'outcome' ? (
                      <span>{makeOutcomeText(transaction.value)}</span>
                    ) : (
